    ...
    try {
      ...
      if (
        ...
        return res
          ...
          .json({
            success: false,
            message:
              "Ya existe una preclínica asociada a esa cita",
          });
      }
      ...
      if (
        ...
        return res
          ...
          .json({
            success: false,
            message:
              "No se pudo crear la preclínica",
          });
      }
      ...
      if (informacionCompleta) {
        ...
        await registrarBitacora({
          ...
          accion:
            "CAMBIO_ESTADO_CITA_POR_PRECLINICA",

          descripcion:
            `Cita ${idCitaNum} -> ` +
            `CONSULTA_MEDICA tras crear ` +
            `preclínica ${idPre}`,
      ...
      res.json({
        ...
        message:
          "Preclínica creada correctamente",

        idPreclinica:
          idPre,

        nota_estado_actualizado:
          informacionCompleta
            ? "CONSULTA_MEDICA"
            : "PRECLINICA",
      });
    ...
    try {
      ...
      if (
        ...
        await registrarBitacora({
          ...
          accion:
            "CAMBIO_ESTADO_CITA_POR_PRECLINICA_UPDATE",

          descripcion:
            `Cita ${idCita} -> ` +
            `CONSULTA_MEDICA tras actualizar ` +
            `preclínica ${idPre}`,
      ...
      res.json({
        ...
        message:
          "Preclínica actualizada correctamente",
      });
    } catch (err) {
      console.error(
        "POST /preclinica/actualizar error:",
        err
      );
      ...
      try {
        await registrarBitacora({
          ...
          accion:
            "ERROR_ACTUALIZACION_PRECLINICA",
  ...
  async (req, res) => {
    try {
      ...
      if (
        ...
        return res
          ...
          .json({
            ...
            message:
              "No existe preclínica para esta cita",
          });
      }
      ...
      if (
        ...
        return res
          ...
          .json({
            ...
            message:
              "La preclínica no contiene la información mínima de peso y talla. Complete la preclínica antes de pasar a consulta.",
          });
      }
      ...
      await registrarBitacora({
        ...
        accion:
          "PASAR_PRECLINICA_A_CONSULTA",

        descripcion:
          `Cita ${id} pasada a ` +
          `CONSULTA_MEDICA, verificada ` +
          `con peso y talla`,
      ...
      res.json({
        ...
        message:
          "Cita pasada a CONSULTA_MEDICA",
      });
    } catch (err) {
      console.error(
        "POST /preclinica/pasar-a-consulta error:",
        err
      );
...
// Eliminar una cita completa (RUTA CORREGIDA)
// ============================================================
