...
// ¡Clave! Si la carpeta de producción no existe, la creamos para evitar SQLITE_CANTOPEN
if (!fs.existsSync(dbFolder)) {
    try {
        fs.mkdirSync(dbFolder, { recursive: true });
        console.log(`Carpeta de base de datos creada en: ${dbFolder}`);
    } catch (err) {
        console.error(`Error al crear la carpeta ${dbFolder}:`, err.message);
    }
}
